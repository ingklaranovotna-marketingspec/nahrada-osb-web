...
const faqs = [
  { q: "Je JSD P5 přímou náhradou za OSB?", a: "V mnoha aplikacích ano. JSD P5 splňuje EN 312 P5 – konstrukční deska vhodná do vlhkého prostředí. Homogennější struktura a hladší povrch jsou bonusy oproti OSB. A co víc – JSD P5 je přitom až o 20 % levnější než srovnatelné OSB desky." },
  { q: "Jsou JSD a HSD opravdu levnější než OSB?", a: "Ano. JSD P5 i HSD P7 jsou přibližně o 20 % levnější než OSB desek srovnatelné třídy. To platí i přesto, že nabízejí lepší vlhkoodolnost, hladší povrch a homogennější strukturu. Konkrétní ceny závisí na tloušťce a formátu – poptejte nás pro aktuální ceníkovou nabídku." },
  ...
  { q: "Co je perodrážka 4PD a kdy ji použít?", a: "4PD (perodrážka ze 4 stran) umožňuje spoje desek bez překrývání – typicky pro plovoucí podlahy. Deska s 4PD se snáze pokládá a tvoří pevnější spoj než ostrohrané verze. Pro podlahové aplikace doporučujeme variantu 4PD." },
